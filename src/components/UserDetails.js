export function UserDetails() {
  return (
    <div className="absolute top-[0rem] right-[75.56%] left-[0%] box-border flex h-[61.38rem] w-[24.44%] flex-col items-start justify-start overflow-y-auto border-r-[1px] border-solid border-darkslategray bg-gray-300 px-[2.81rem] pt-[1.88rem] pb-[0.94rem] text-[1rem] shadow-[14px_0px_30px_rgba(0,_0,_0,_0.5)] scrollbar-hide">
      <div className="relative h-[58.56rem] w-[16.38rem] shrink-0 overflow-y-auto scrollbar-hide">
        ...
        <div className="absolute top-[16.13rem] left-[0rem] flex h-[31.06rem] w-[16.38rem] flex-col items-center justify-start gap-[0.31rem] overflow-hidden rounded-base">
          <div className="flex flex-row items-start justify-start self-stretch rounded-base bg-white text-black">
            <div className="box-border flex w-[16.38rem] shrink-0 flex-row items-start justify-start gap-[1.25rem] rounded-base bg-white py-[1.13rem] pr-[2.5rem] pl-[0.94rem]">
              <img
          ...
          <div className="flex flex-row items-start justify-start gap-[1.25rem] self-stretch rounded-base bg-gray-200 py-[1.13rem] pr-[2.5rem] pl-[0.94rem]">
            <img
              className="relative h-[1.25rem] w-[1.25rem] shrink-0 overflow-hidden"
              alt=""
              src="../icon.svg"
        ...
        <div className="absolute top-[48.06rem] left-[0rem] flex w-[16.38rem] flex-col items-center justify-center overflow-hidden rounded-base">
          <div className="box-border flex w-[16.38rem] flex-row items-start justify-start gap-[1.25rem] rounded-base bg-gray-200 py-[1.13rem] pr-[2.5rem] pl-[0.94rem]">
            <img
              className="relative h-[1.25rem] w-[1.25rem] shrink-0 overflow-hidden"
              alt=""
              src="../icon4.svg"
